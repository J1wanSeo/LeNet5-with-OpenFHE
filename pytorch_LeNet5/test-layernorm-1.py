...
def quad_relu(x):
    ...
    #return 1.5522*10**(-9)*x**18 -1.7764*10**(-7)*x**16 + 8.5114*10**(-6)*x**14 -2.2146*10**(-4)*x**12 + 3.3960*10**(-3)*x**10 - 3.1183*10**(-2)*x**8 + 1.6707*10**(-1)*x**6 - 4.9304*10**(-1)*x**4 + 8.5369*10**(-1)*x**2 + 0.5*x + 3.8838*10**-2
class Net(nn.Module):
