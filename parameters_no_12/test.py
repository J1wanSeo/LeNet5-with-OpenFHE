...
# bn load
gamma_tensor = load_txt_tensor("conv1_bn_gamma.txt", (6,))
beta_tensor = load_txt_tensor("conv1_bn_beta.txt", (6,))
mean_tensor = load_txt_tensor("conv1_bn_mean.txt", (6,))
var_tensor = load_txt_tensor("conv1_bn_var.txt", (6,))
